                ...
                >
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      const ItemContent = (
                        <div className="flex items-start gap-6 group transition-all duration-300">
                          <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center text-primary shrink-0 transition-all duration-300 group-hover:bg-primary group-hover:text-white">
                            <Icon size={24} />
                          </div>
                          <div>
                            <span className="text-lg text-white font-bold mb-1">{t(item.label) || item.label}</span>
                            <p className="text-white transition-colors group-hover:text-text-primary">{item.value}</p>
                          </div>
                        </div>
                      );
                      ...
                      if (isLink) {
                        return (
                          <motion.a 
                            ...
                            className="block p-2 -m-2 text-white rounded-2xl hover:bg-white/[0.03] transition-colors"
                          >
                            {ItemContent}
                          </motion.a>
                        );
                    ...
                    <motion.div
                      ...
                      className="mt-10 overflow-hidden rounded-3xl border border-white/10 p-1 bg-white/5 backdrop-blur-sm"
                    >
                      <div className="w-full h-[300px] rounded-[22px] overflow-hidden grayscale invert-[0.9] opacity-80 hover:grayscale-0 hover:invert-0 hover:opacity-100 transition-all duration-700">
                        <iframe
                          src={`https://maps.google.com/maps?q=${encodeURIComponent("CJ5W+H8 Mỹ An Hưng, Đồng Tháp, Việt Nam")}&z=15&output=embed`}
                          width="100%"
                          height="100%"
                          style={{ border: 0 }}
                          allowFullScreen
